// src/components/ui/PixelBlast.tsx
...
export function PixelBlast({
  className = '',
  particleCount = 200,
  colors = ['#6F4FF2', '#3B82F6', '#8B5CF6', '#06B6D4', '#14F195', '#A855F7'],
  interactive = true,
}: PixelBlastProps) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      gradient.addColorStop(0, 'rgba(111, 79, 242, 0.15)');
      ...
      ctx.strokeStyle = 'rgba(111, 79, 242, 0.1)';
      ctx.lineWidth = 0.5;
